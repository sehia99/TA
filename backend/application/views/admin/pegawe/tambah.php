        ...
        <?php if ($this->session->flashdata('success')): ?>
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('sadmin/pegawe/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('sadmin/pegawe/add') ?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('no_hp') ? 'is-invalid':'' ?>"
								 type="text" name="no_hp" min="0" placeholder="No. HP" />
								<div class="invalid-feedback">
